        ...
        <div className="flex justify-between items-center text-xs tracking-wider font-semibold mb-1">
          <div className="flex items-center gap-2">
            <svg
              ...
              viewBox="0 0 24 24"
            >
              <path d="M12 4a2 2 0 012 2c0 1.1-.9 2-2 2a2 2 0 01-2-2c0-1.1.9-2 2-2zm0 4v2m0 0L4 15v2h16v-2L12 10z" />
            </svg>
            <span className="text-sm font-bold tracking-widest">STYLECUE</span>
          </div>
