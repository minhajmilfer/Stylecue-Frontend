    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-[#312359] to-[#802a64] p-8 text-white relative overflow-hidden">
      ...
      <div className="flex flex-col items-center mb-8 z-10">
        <Image 
          ...
          height={390} 
          priority
          className="w-[300px] sm:w-[440px] md:w-[560px] h-auto drop-shadow-[0_0_40px_rgba(255,255,255,0.45)] transition-all"
        />
        <h1 className="text-4xl sm:text-5xl md:text-[3.25rem] font-bold tracking-[0.4em] uppercase text-white drop-shadow-[0_0_25px_rgba(255,255,255,0.5)] -mt-4 md:-mt-6">
          STYLECUE
        </h1>
      </div>
